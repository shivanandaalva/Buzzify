...
export default function Headlines({navigation}) {
  ...
  useEffect(() => {
    ...
    await fetch('https://news.google.com/rss/topics/CAAqKggKIiRDQkFTRlFvSUwyMHZNRFp1ZEdvU0JXVnVMVWRDR2dKSlRpZ0FQAQ?hl')
  ...
  const data= sports.map((data)=>(data.links.map((e)=>
